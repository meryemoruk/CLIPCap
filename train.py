...
if __name__ == '__main__':
    ...
    parser.add_argument('--encoder_dim',default=1280, help='the dimension of extracted features using different network')
    ...
    parser.add_argument('--attention_dim', type=int, default=1280)
